...
const HomeIcon = () => (
  <svg viewBox="0 0 24 24" fill="#f5ebe3" xmlns="http://www.w3.org/2000/svg">
...
const CassetteIcon = () => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="8" y="16" width="48" height="32" rx="4" fill="#f3e8dd" />
    <rect x="14" y="22" width="36" height="14" fill="#cfac8a" />
    <circle cx="22" cy="29" r="4" fill="#341217" />
    <circle cx="42" cy="29" r="4" fill="#341217" />
    <path d="M20 42h24l2-6H18l2 6z" fill="#5a2732" />
  </svg>
);

const NetworkIcon = () => (
  <svg viewBox="0 0 64 64" fill="none" stroke="#f5ebe3" strokeWidth="3" xmlns="http://www.w3.org/2000/svg">
...
const NavigationMenu = ({ isOpen, onClose, onNavigateHome, onNavigateConnections, onNavigateGallery, onNavigateSettings }) => {
    ...
    <div className="nav-overlay" onClick={onClose}>
      <div className="nav-content" onClick={e => e.stopPropagation()}>
        ...
        <main className="nav-grid">
           <button type="button" className="nav-item nav-item-btn" onClick={onNavigateHome}>
             <HomeIcon />
           </button>
           <div className="nav-item"><RecordIcon /></div>
           <div className="nav-item"><CassetteIcon /></div>
           <button type="button" className="nav-item nav-item-btn" onClick={onNavigateConnections}>
             <NetworkIcon />
           </button>
           <button type="button" className="nav-item nav-item-btn" onClick={onNavigateGallery}>
             <GalleryIcon />
           </button>
           <button type="button" className="nav-item nav-item-btn" onClick={onNavigateSettings}>
             <SettingsIcon />
           </button>
        </main>
      </div>
